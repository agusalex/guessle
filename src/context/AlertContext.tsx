...
type AlertStatus = 'success' | 'error' | 'maybe' | undefined
...
type AlertContextValue = {
  ...
  showMaybe: (message: string, options?: ShowOptions) => void
...
export const AlertProvider = ({ children }: Props) => {
  ...
  const showMaybe = useCallback(
      (newMessage: string, options?: ShowOptions) => {
        show('maybe', newMessage, options)
      },
      [show]
  )
